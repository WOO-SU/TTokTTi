...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        WorkSessionMember.objects.all().delete()
        Photo.objects.all().delete()
        Compliance.objects.all().delete()
        VideoLogRead.objects.all().delete()
        VideoLog.objects.all().delete()
        RiskAssessmentImage.objects.all().delete()
        WorkerRecommendation.objects.all().delete()
        RiskReport.objects.all().delete()
        RiskAssessment.objects.all().delete()
        PostWorkReport.objects.all().delete()
