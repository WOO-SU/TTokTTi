...
const workSiteCards: WorkSiteCard[] = [
  {
    ...
    workStatus: '작업 중',
    equipmentCheck: [
      { memberId: 2, name: '송영민', complied: true },
      { memberId: 3, name: '임정원', complied: false },
    ],
  ...
  },
  {
    ...
    workStatus: '작업 중',
    equipmentCheck: [
      { memberId: 4, name: '김태호', complied: true },
      { memberId: 5, name: '박지수', complied: true },
    ],
  ...
  },
  {
    ...
    workStatus: '작업 전',
    equipmentCheck: [
      { memberId: 6, name: '이준혁', complied: false },
      { memberId: 7, name: '최서연', complied: false },
    ],
    riskAssessmentDone: false,
    reportDone: false,
  },
  {
    ...
    startTime: '09:10',
    location: '보라매동',
    members: [{ id: 8, name: '우수연' }, { id: 9, name: '원인영' }],
    workStatus: '작업 끝',
    equipmentCheck: [
      { memberId: 8, name: '우수연', complied: true },
      { memberId: 9, name: '원인영', complied: true },
    ],
    riskAssessmentDone: true,
    reportDone: true,
    reportId: 1,
