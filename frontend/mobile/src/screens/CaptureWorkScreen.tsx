...
type Props = {
    navigation: NativeStackNavigationProp<RootStackParamList, 'CaptureWork'>;
    route: RouteProp<RootStackParamList, 'CaptureWork'>;
};
...
export default function CaptureWorkScreen({ navigation, route }: Props) {
    ...
    const handleSend = useCallback(async () => {
        ...
        try {
            ...
            // 2. Call target API with BEFORE status
            await uploadTargetPhoto(worksessionId, 'BEFORE', blob_name);
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
                ...
                <Text style={styles.headerTitle}>작업물 촬영 (작업 전)</Text>
            </View>

            {/* Idle State */}
            {screenState === 'idle' && (
                <View style={styles.idleContent}>
                    <Text style={styles.idleTitle}>작업을 시작하기 전</Text>
                    <Text style={styles.idleSubtitle}>작업 대상 사진을 촬영해주세요</Text>
                    <TouchableOpacity
                        style={styles.startCameraButton}
                        activeOpacity={0.8}
                        onPress={handleStartCamera}>
                        <Text style={styles.startCameraButtonText}>대상 촬영</Text>
                    </TouchableOpacity>
                </View>
            )}
